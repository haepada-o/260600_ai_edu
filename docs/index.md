...
<h4 style="margin: 0 0 8px 0; font-size: 1rem; font-weight: 700; color: var(--md-default-fg-color--light);">준비 중</h4>
<p style="margin: 0; font-size: 0.78rem; color: var(--md-default-fg-color--lightest);">지난 강의들이 순차적으로 업데이트 됩니다.</p>
</div>
</div>
</div>
