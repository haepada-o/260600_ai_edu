...
### 6-3. 🇰🇷 한국 정부·공공 AI 가이드라인 & 법률 자료

!!! important "2026.08 시행 예정"
    **「인공지능 및 데이터 기반 행정 활성화에 관한 법률」**이 2026년 8월 시행 예정입니다.
    공공기관 AI 도입 시 이 법률의 요건을 반드시 확인하세요.

#### 공공부문 AI 도입 가이드

| 자료명 | 배포 기관 | 핵심 내용 | 참고 |
|---|---|---|---|
| **공공부문 초거대 AI 도입·활용 가이드라인 2.0** | 디지털플랫폼정부위원회 | 행정 혁신, RAG 기술 활용, 보안 체크리스트 | 2025.04 공개 |
| **공공부문 AI 도입·활용 가이드** | 행정안전부 | 기획→예산→계약→구축→운영 5단계 표준화 | 2026.06 배포 |
| **국가·공공기관 AI 보안 가이드북** | 국가정보원 | 15개 보안 위협 유형, 30개 대책, 비공개 정보 입력 금지 | [aikorea.go.kr](https://aikorea.go.kr) |
| **인공지능(AI) 업무활용 가이드** | 인사혁신처 | 공무원 실전 매뉴얼: 프롬프트 작성, 문서 요약, 보도자료 초안 | [data.go.kr](https://data.go.kr) |

#### AI 친화적 문서 작성 가이드라인

| 원칙 | 설명 | 기존 관행 → 개선 방향 |
|---|---|---|
| **주어·서술어 명확 기술** | AI가 문서를 정확히 파싱할 수 있도록 | "~에 대한 건" → "OO부서가 OO을 요청합니다" |
| **복잡한 셀 병합 금지** | 표 데이터를 AI가 구조적으로 읽을 수 있도록 | 병합된 엑셀 → 단순한 표 구조 |
| **마크다운(Markdown) 도입** | AI 학습·관리에 용이한 형식 | 워드/한글 서식 → 마크다운 문서 |
| **공문서 표준 번호 체계** | 문서 간 참조 및 검색 가능성 확보 | 자유 형식 → 표준화된 번호 체계 |
...
| 자료명 | 배포 기관 | 핵심 |
|---|---|---|
| **생성형 AI 개발·활용 개인정보 처리 안내서** | 개인정보보호위원회 | AI 생애주기별 개인정보 보호 기준 (2025.08) |
| **AI 보안 가이드북** | 국정원 | 비공개 정보 입력 금지, 교차 검증 의무화 |
...
| 디지털플랫폼정부위원회 | [dpg.go.kr](https://dpg.go.kr) | 공공 AI 도입 가이드 |
| 공공데이터포털 | [data.go.kr](https://data.go.kr) | AI 업무활용 가이드 다운로드 |
| 한국지능정보사회진흥원 | [nia.or.kr](https://nia.or.kr) | AI 교육·실습 자료 |
